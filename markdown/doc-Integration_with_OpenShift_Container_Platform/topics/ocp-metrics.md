In order for {product-title\_short} to collect OpenShift Container
...
{product-title\_short} can reach the Hawkular Metrics service. The base
...
that {product-title\_short} will use to reach the Hawkular Metrics
