{product-title} supports Microsoft Azure providers. Before
{product-title\_short} can be authenticated to Microsoft Azure, you must
...
as a provider in {product-title\_short}. Currently, all of these steps
...
cloud instance as a provider to {product-title\_short}.
